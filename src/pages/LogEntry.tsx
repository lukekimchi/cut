...
import { getDailyLog, getMeals, addMeal, deleteMeal, logWeight } from '../services/logs';
...
export function LogEntry({ onNavigate: _ }: LogEntryProps) {
  ...
  return (
    <div className="page">
      ...
      {!showForm ? (
        <button className="btn btn-secondary add-meal-btn" onClick={() => setShowForm(true)}>
          + Add Meal / Snack
        </button>
      ) : (
